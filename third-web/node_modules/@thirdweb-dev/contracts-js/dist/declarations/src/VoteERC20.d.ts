...
export interface VoteERC20 extends BaseContract {
    ...
    functions: {
        ...
        castVoteWithReasonAndParamsBySig(proposalId: BigNumberish, support: BigNumberish, reason: string, params: BytesLike, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        getVotesWithParams(account: string, blockNumber: BigNumberish, params: BytesLike, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "quorumNumerator(uint256)"(blockNumber: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        castVoteWithReasonAndParamsBySig(proposalId: BigNumberish, support: BigNumberish, reason: string, params: BytesLike, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        contractType(overrides?: CallOverrides): Promise<string>;
        contractURI(overrides?: CallOverrides): Promise<string>;
        contractVersion(overrides?: CallOverrides): Promise<number>;
    ...
    populateTransaction: {
        ...
        getVotesWithParams(account: string, blockNumber: BigNumberish, params: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "quorumNumerator(uint256)"(blockNumber: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=VoteERC20.d.ts.map