 ...
 * @public
 */
class EditionDrop extends getContract.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, _address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new getContract.ContractWrapper(network, _address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "claimTo", getContract.buildTransactionFunction(async function (destinationAddress, tokenId, quantity) {
     ...
     * @returns - Receipt for the transaction
     */
    QueryParams._defineProperty(this, "claim", getContract.buildTransactionFunction(async function (tokenId, quantity) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", getContract.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = abi;
    this.metadata = new getContract.ContractMetadata(this.contractWrapper, getContract.DropErc1155ContractSchema, this.storage);
    this.app = new getContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new getContract.ContractRoles(this.contractWrapper, EditionDrop.contractRoles);
    ...
    this.claimConditions = new getContract.DropErc1155ClaimConditions(this.contractWrapper, this.metadata, this.storage);
    this.events = new getContract.ContractEvents(this.contractWrapper);
    this.history = new getContract.DropErc1155History(this.events);
