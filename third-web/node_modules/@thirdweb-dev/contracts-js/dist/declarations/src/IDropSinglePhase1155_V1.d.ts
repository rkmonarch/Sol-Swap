...
export interface IDropSinglePhase1155_V1 extends BaseContract {
    ...
    functions: {
        claim(receiver: string, tokenId: BigNumberish, quantity: BigNumberish, currency: string, pricePerToken: BigNumberish, allowlistProof: IDropSinglePhase1155_V1.AllowlistProofStruct, data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setClaimConditions(tokenId: BigNumberish, phase: IClaimCondition_V1.ClaimConditionStruct, resetClaimEligibility: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    claim(receiver: string, tokenId: BigNumberish, quantity: BigNumberish, currency: string, pricePerToken: BigNumberish, allowlistProof: IDropSinglePhase1155_V1.AllowlistProofStruct, data: BytesLike, overrides?: PayableOverrides & {
    ...
    callStatic: {
        claim(receiver: string, tokenId: BigNumberish, quantity: BigNumberish, currency: string, pricePerToken: BigNumberish, allowlistProof: IDropSinglePhase1155_V1.AllowlistProofStruct, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        setClaimConditions(tokenId: BigNumberish, phase: IClaimCondition_V1.ClaimConditionStruct, resetClaimEligibility: boolean, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=IDropSinglePhase1155_V1.d.ts.map