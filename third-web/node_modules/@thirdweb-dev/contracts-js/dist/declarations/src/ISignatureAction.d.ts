...
export interface ISignatureActionInterface extends utils.Interface {
    functions: {
...
export interface ISignatureAction extends BaseContract {
    ...
    functions: {
        verify(req: ISignatureAction.GenericRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    };
    ...
    estimateGas: {
        verify(req: ISignatureAction.GenericRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        verify(req: ISignatureAction.GenericRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=ISignatureAction.d.ts.map