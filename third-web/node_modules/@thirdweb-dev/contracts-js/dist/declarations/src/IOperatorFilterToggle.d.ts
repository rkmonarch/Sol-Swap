...
export interface IOperatorFilterToggleInterface extends utils.Interface {
    functions: {
        "operatorRestriction()": FunctionFragment;
        "setOperatorRestriction(bool)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "operatorRestriction" | "setOperatorRestriction"): FunctionFragment;
...
export interface IOperatorFilterToggle extends BaseContract {
    ...
    functions: {
        ...
        setOperatorRestriction(restriction: boolean, overrides?: Overrides & {
    ...
    callStatic: {
        operatorRestriction(overrides?: CallOverrides): Promise<boolean>;
        setOperatorRestriction(restriction: boolean, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=IOperatorFilterToggle.d.ts.map