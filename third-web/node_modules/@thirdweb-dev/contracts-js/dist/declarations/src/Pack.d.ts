...
export interface PackInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "addPackContents" | "balanceOf" | "balanceOfBatch" | "canUpdatePack" | "contractType" | "contractURI" | "contractVersion" | "createPack" | "getDefaultRoyaltyInfo" | "getPackContents" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getRoyaltyInfoForToken" | "getTokenCountOfBundle" | "getTokenOfBundle" | "getUriOfBundle" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isApprovedForAll" | "isTrustedForwarder" | "multicall" | "name" | "nextTokenIdToMint" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "openPack" | "owner" | "renounceRole" | "revokeRole" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "totalSupply" | "uri"): FunctionFragment;
    encodeFunctionData(functionFragment: "DEFAULT_ADMIN_ROLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "addPackContents", values: [BigNumberish, ITokenBundle.TokenStruct[], BigNumberish[], string]): string;
    ...
    encodeFunctionData(functionFragment: "canUpdatePack", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "addPackContents", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOfBatch", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "canUpdatePack", data: BytesLike): Result;
...
export interface Pack extends BaseContract {
    ...
    functions: {
        ...
        addPackContents(_packId: BigNumberish, _contents: ITokenBundle.TokenStruct[], _numOfRewardUnits: BigNumberish[], _recipient: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        balanceOf(account: string, id: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber[]]>;
        canUpdatePack(arg0: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        addPackContents(_packId: BigNumberish, _contents: ITokenBundle.TokenStruct[], _numOfRewardUnits: BigNumberish[], _recipient: string, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
    ...
    estimateGas: {
        ...
        balanceOf(account: string, id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber>;
        canUpdatePack(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        canUpdatePack(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
