...
export interface IContractDeployerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deployInstance" | "deployInstanceProxy" | "getContractDeployer"): FunctionFragment;
...
export interface IContractDeployer extends BaseContract {
    ...
    functions: {
        deployInstance(publisher: string, contractBytecode: BytesLike, constructorArgs: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployInstanceProxy(publisher: string, implementation: string, initializeData: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getContractDeployer(_contract: string, overrides?: CallOverrides): Promise<[string]>;
    };
    deployInstance(publisher: string, contractBytecode: BytesLike, constructorArgs: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: Overrides & {
        from?: string | Promise<string>;
    }): Promise<ContractTransaction>;
    ...
    getContractDeployer(_contract: string, overrides?: CallOverrides): Promise<string>;
    callStatic: {
        deployInstance(publisher: string, contractBytecode: BytesLike, constructorArgs: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: CallOverrides): Promise<string>;
        deployInstanceProxy(publisher: string, implementation: string, initializeData: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: CallOverrides): Promise<string>;
        getContractDeployer(_contract: string, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        getContractDeployer(_contract: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        deployInstance(publisher: string, contractBytecode: BytesLike, constructorArgs: BytesLike, salt: BytesLike, value: BigNumberish, publishMetadataUri: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        getContractDeployer(_contract: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
