...
export interface ISignatureMintERC721 extends BaseContract {
    ...
    functions: {
        mintWithSignature(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        verify(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    };
    ...
    callStatic: {
        mintWithSignature(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<string>;
        verify(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    ...
    estimateGas: {
        ...
        verify(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        mintWithSignature(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        verify(req: ISignatureMintERC721.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=ISignatureMintERC721.d.ts.map