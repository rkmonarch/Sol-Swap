...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return getContract.assertEnabled(this.detectDirectListings(), getContract.FEATURE_DIRECT_LISTINGS);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return getContract.assertEnabled(this.detectEnglishAuctions(), getContract.FEATURE_ENGLISH_AUCTIONS);
  }
   ...
   */
  get offers() {
    return getContract.assertEnabled(this.detectOffers(), getContract.FEATURE_OFFERS);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new getContract.ContractRoles(this.contractWrapper, MarketplaceV3.contractRoles);
  ...
  detectDirectListings() {
    if (getContract.detectContractFeature(this.contractWrapper, "DirectListings")) {
      return new getContract.MarketplaceV3DirectListings(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if (getContract.detectContractFeature(this.contractWrapper, "EnglishAuctions")) {
      return new getContract.MarketplaceV3EnglishAuctions(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if (getContract.detectContractFeature(this.contractWrapper, "Offers")) {
      return new getContract.MarketplaceV3Offers(this.contractWrapper, this.storage);
    }
    return undefined;
  }
}
