 ...
 * @public
 */
class NFTCollection extends getContract.StandardErc721 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mint", getContract.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", getContract.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatch", getContract.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", getContract.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", getContract.buildTransactionFunction(tokenId => {
      return this.erc721.burn.prepare(tokenId);
    }));
    this.abi = abi;
    this.metadata = new getContract.ContractMetadata(this.contractWrapper, getContract.TokenErc721ContractSchema, this.storage);
    this.app = new getContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new getContract.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
    ...
    this.signature = new getContract.Erc721WithQuantitySignatureMintable(this.contractWrapper, this.storage);
