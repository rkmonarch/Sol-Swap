...
export interface ERC1155DelayedRevealInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "OPERATOR_FILTER_REGISTRY" | "balanceOf" | "balanceOfBatch" | "burn" | "burnBatch" | "claim" | "contractURI" | "encryptDecrypt" | "encryptedData" | "getBaseURICount" | "getBatchIdAtIndex" | "getDefaultRoyaltyInfo" | "getRevealURI" | "getRoyaltyInfoForToken" | "isApprovedForAll" | "isEncryptedBatch" | "lazyMint" | "multicall" | "name" | "nextTokenIdToMint" | "operatorRestriction" | "owner" | "reveal" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOperatorRestriction" | "setOwner" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "totalSupply" | "uri" | "verifyClaim"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "claim", values: [string, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "verifyClaim", values: [string, BigNumberish, BigNumberish]): string;
...
export interface ERC1155DelayedReveal extends BaseContract {
    ...
    functions: {
        ...
        claim(_receiver: string, _tokenId: BigNumberish, _quantity: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        verifyClaim(_claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
    };
    OPERATOR_FILTER_REGISTRY(overrides?: CallOverrides): Promise<string>;
    balanceOf(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber[]>;
    ...
    callStatic: {
        ...
        claim(_receiver: string, _tokenId: BigNumberish, _quantity: BigNumberish, overrides?: CallOverrides): Promise<void>;
        contractURI(overrides?: CallOverrides): Promise<string>;
        encryptDecrypt(data: BytesLike, key: BytesLike, overrides?: CallOverrides): Promise<string>;
        encryptedData(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getBaseURICount(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    estimateGas: {
        ...
        verifyClaim(_claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        verifyClaim(_claimer: string, _tokenId: BigNumberish, _quantity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=ERC1155DelayedReveal.d.ts.map