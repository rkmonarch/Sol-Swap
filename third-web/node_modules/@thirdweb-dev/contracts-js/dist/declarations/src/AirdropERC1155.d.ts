...
export interface AirdropERC1155Interface extends utils.Interface {
    functions: {
        ...
        "airdrop(address,address,(address,address,address,uint256,uint256)[])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "addAirdropRecipients" | "airdrop(address,address,(address,address,address,uint256,uint256)[])" | "airdrop(uint256)" | "contractType" | "contractVersion" | "getAllAirdropPayments" | "getAllAirdropPaymentsFailed" | "getAllAirdropPaymentsPending" | "getAllAirdropPaymentsProcessed" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "multicall" | "owner" | "payeeCount" | "processedCount" | "renounceRole" | "revokeRole" | "setOwner"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "airdrop(address,address,(address,address,address,uint256,uint256)[])", values: [string, string, IAirdropERC1155.AirdropContentStruct[]]): string;
    encodeFunctionData(functionFragment: "airdrop(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "airdrop(address,address,(address,address,address,uint256,uint256)[])", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "airdrop(uint256)", data: BytesLike): Result;
...
export interface AirdropERC1155 extends BaseContract {
    ...
    functions: {
        ...
        "airdrop(address,address,(address,address,address,uint256,uint256)[])"(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC1155.AirdropContentStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "airdrop(uint256)"(paymentsToProcess: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "airdrop(address,address,(address,address,address,uint256,uint256)[])"(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC1155.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
        "airdrop(uint256)"(paymentsToProcess: BigNumberish, overrides?: CallOverrides): Promise<void>;
        contractType(overrides?: CallOverrides): Promise<string>;
        contractVersion(overrides?: CallOverrides): Promise<number>;
        getAllAirdropPayments(overrides?: CallOverrides): Promise<IAirdropERC1155.AirdropContentStructOutput[]>;
        getAllAirdropPaymentsFailed(overrides?: CallOverrides): Promise<IAirdropERC1155.AirdropContentStructOutput[]>;
