...
export interface PaymentSplitterUpgradeableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "payee" | "payeeCount" | "releasable(address)" | "releasable(address,address)" | "release(address)" | "release(address,address)" | "released(address,address)" | "released(address)" | "shares" | "totalReleased(address)" | "totalReleased()" | "totalShares"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "releasable(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "releasable(address,address)", values: [string, string]): string;
...
export type ERC20PaymentReleasedEventFilter = TypedEventFilter<ERC20PaymentReleasedEvent>;
...
export interface PaymentSplitterUpgradeable extends BaseContract {
    ...
    functions: {
        ...
        "releasable(address)"(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        "releasable(address,address)"(token: string, account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        "releasable(address)"(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "releasable(address,address)"(token: string, account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "release(address)"(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
...
//# sourceMappingURL=PaymentSplitterUpgradeable.d.ts.map