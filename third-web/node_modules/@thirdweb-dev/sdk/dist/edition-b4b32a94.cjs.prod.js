 ...
 * @public
 */
class Edition extends getContract.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", getContract.buildTransactionFunction(async metadataWithSupply => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", getContract.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintAdditionalSupply", getContract.buildTransactionFunction(async (tokenId, additionalSupply) => {
     ...
     * @param additionalSupply - the additional amount to mint
     */
    QueryParams._defineProperty(this, "mintAdditionalSupplyTo", getContract.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintBatch", getContract.buildTransactionFunction(async metadatas => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", getContract.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", getContract.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = abi;
    this.metadata = new getContract.ContractMetadata(this.contractWrapper, getContract.TokenErc1155ContractSchema, this.storage);
    this.app = new getContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new getContract.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new getContract.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
