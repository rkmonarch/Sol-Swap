 ...
 *
 */
class TokenDrop extends getContract.StandardErc20 {
  /**
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claim", getContract.buildTransactionFunction(async function (amount) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", getContract.buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", getContract.buildTransactionFunction(async amount => {
    ...
    this.abi = abi;
    this.metadata = new getContract.ContractMetadata(this.contractWrapper, getContract.DropErc20ContractSchema, this.storage);
    this.app = new getContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new getContract.ContractRoles(this.contractWrapper, TokenDrop.contractRoles);
