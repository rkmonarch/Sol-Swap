...
export interface IDropERC1155 extends BaseContract {
    ...
    functions: {
        ...
        claim(receiver: string, tokenId: BigNumberish, quantity: BigNumberish, currency: string, pricePerToken: BigNumberish, allowlistProof: IDropERC1155.AllowlistProofStruct, data: BytesLike, overrides?: PayableOverrides & {
    ...
    callStatic: {
        balanceOf(account: string, id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber[]>;
        claim(receiver: string, tokenId: BigNumberish, quantity: BigNumberish, currency: string, pricePerToken: BigNumberish, allowlistProof: IDropERC1155.AllowlistProofStruct, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        isApprovedForAll(account: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
