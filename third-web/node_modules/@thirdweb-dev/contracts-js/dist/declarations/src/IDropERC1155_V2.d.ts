...
export interface IDropERC1155_V2 extends BaseContract {
    ...
    functions: {
        ...
        setClaimConditions(tokenId: BigNumberish, phases: IDropClaimCondition_V2.ClaimConditionStruct[], resetClaimEligibility: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setClaimConditions(tokenId: BigNumberish, phases: IDropClaimCondition_V2.ClaimConditionStruct[], resetClaimEligibility: boolean, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
...
//# sourceMappingURL=IDropERC1155_V2.d.ts.map