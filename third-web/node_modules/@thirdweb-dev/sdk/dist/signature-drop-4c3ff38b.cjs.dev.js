 ...
 * @public
 */
class SignatureDrop extends getContract.StandardErc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", getContract.buildTransactionFunction(async (destinationAddress, quantity, options) => {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", getContract.buildTransactionFunction(async (quantity, options) => {
    ...
    this.roles = new getContract.ContractRoles(this.contractWrapper, SignatureDrop.contractRoles);
