...
export interface IDelayedRevealDeprecatedInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "encryptDecrypt" | "encryptedBaseURI" | "reveal"): FunctionFragment;
...
export interface IDelayedRevealDeprecated extends BaseContract {
    ...
    functions: {
        ...
        encryptedBaseURI(identifier: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        encryptedBaseURI(identifier: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        reveal(identifier: BigNumberish, key: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        encryptedBaseURI(identifier: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        reveal(identifier: BigNumberish, key: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=IDelayedRevealDeprecated.d.ts.map