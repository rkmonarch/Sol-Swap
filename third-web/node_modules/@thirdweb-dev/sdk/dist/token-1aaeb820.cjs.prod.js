 ...
 * @public
 */
class Token extends getContract.StandardErc20 {
  /**
   * Signature Minting
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", getContract.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", getContract.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", getContract.buildTransactionFunction(async args => {
     ...
     * @alpha
     */
    QueryParams._defineProperty(this, "delegateTo", getContract.buildTransactionFunction(async delegateeAddress => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", getContract.buildTransactionFunction(amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnFrom", getContract.buildTransactionFunction(async (holder, amount) => {
      return this.erc20.burnFrom.prepare(holder, amount);
    }));
    this.abi = abi;
    this.metadata = new getContract.ContractMetadata(this.contractWrapper, getContract.TokenErc20ContractSchema, this.storage);
    this.app = new getContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new getContract.ContractRoles(this.contractWrapper, Token.contractRoles);
    ...
    this.history = new getContract.TokenERC20History(this.contractWrapper, this.events);
    ...
    this.signature = new getContract.Erc20SignatureMintable(this.contractWrapper, this.roles);
  }
