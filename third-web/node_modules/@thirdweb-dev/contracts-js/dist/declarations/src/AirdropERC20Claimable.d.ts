...
export interface AirdropERC20ClaimableInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "airdropTokenAddress" | "availableAmount" | "claim" | "contractType" | "contractVersion" | "expirationTimestamp" | "initialize" | "isTrustedForwarder" | "maxWalletClaimCount" | "merkleRoot" | "multicall" | "owner" | "setOwner" | "supplyClaimedByWallet" | "tokenOwner" | "verifyClaim"): FunctionFragment;
...
export interface AirdropERC20Claimable extends BaseContract {
    ...
    functions: {
        ...
        initialize(_defaultAdmin: string, _trustedForwarders: string[], _tokenOwner: string, _airdropTokenAddress: string, _airdropAmount: BigNumberish, _expirationTimestamp: BigNumberish, _maxWalletClaimCount: BigNumberish, _merkleRoot: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        contractVersion(overrides?: CallOverrides): Promise<number>;
        expirationTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_defaultAdmin: string, _trustedForwarders: string[], _tokenOwner: string, _airdropTokenAddress: string, _airdropAmount: BigNumberish, _expirationTimestamp: BigNumberish, _maxWalletClaimCount: BigNumberish, _merkleRoot: BytesLike, overrides?: CallOverrides): Promise<void>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
        maxWalletClaimCount(overrides?: CallOverrides): Promise<BigNumber>;
        merkleRoot(overrides?: CallOverrides): Promise<string>;
...
//# sourceMappingURL=AirdropERC20Claimable.d.ts.map