...
export interface EditionStakeInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "claimRewards" | "contractType" | "contractURI" | "contractVersion" | "depositRewardTokens" | "getDefaultRewardsPerUnitTime" | "getDefaultTimeUnit" | "getRewardTokenBalance" | "getRewardsPerUnitTime" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getStakeInfo" | "getStakeInfoForToken" | "getTimeUnit" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "indexedTokens" | "initialize" | "isIndexed" | "isTrustedForwarder" | "multicall" | "onERC1155BatchReceived" | "onERC1155Received" | "renounceRole" | "revokeRole" | "rewardToken" | "setContractURI" | "setDefaultRewardsPerUnitTime" | "setDefaultTimeUnit" | "setRewardsPerUnitTime" | "setTimeUnit" | "stake" | "stakers" | "stakersArray" | "stakingToken" | "supportsInterface" | "withdraw" | "withdrawRewardTokens"): FunctionFragment;
...
export interface EditionStake extends BaseContract {
    ...
    functions: {
        ...
        initialize(_defaultAdmin: string, _contractURI: string, _trustedForwarders: string[], _rewardToken: string, _stakingToken: string, _defaultTimeUnit: BigNumberish, _defaultRewardsPerUnitTime: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hasRoleWithSwitch(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        indexedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_defaultAdmin: string, _contractURI: string, _trustedForwarders: string[], _rewardToken: string, _stakingToken: string, _defaultTimeUnit: BigNumberish, _defaultRewardsPerUnitTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isIndexed(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
...
//# sourceMappingURL=EditionStake.d.ts.map